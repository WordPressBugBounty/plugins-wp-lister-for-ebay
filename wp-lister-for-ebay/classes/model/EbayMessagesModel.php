...
class EbayMessagesModel extends WPL_Model {
	...
	function insertOrUpdate( $data, $Detail ) {
		...
		if ( $message ) {
			...
			if ( ! $result ) {
				...
				WPLE()->logger->debug( $wpdb->last_query );
	...
	function getPageItems( $current_page, $per_page ) {
        ...
        $allowed_orderby = array( 'received_date', 'expiration_date' );
        $orderby  = wple_sanitize_orderby( isset($_REQUEST['orderby']) ? $_REQUEST['orderby'] : '', $allowed_orderby, 'received_date' );
